...
public class LoginApp extends JFrame {
	...
	public LoginApp() {
		...
		// NOTE: pass references to my privates that the listener needs to do
		// its job
	...
	private class LoginAppListener implements ActionListener {
		/**
		 * The heart of an ActionListener - this gets called when the event is
		 * fired. Need to authenticate the user and display appropriate message
		 * on the UI.
		 */
