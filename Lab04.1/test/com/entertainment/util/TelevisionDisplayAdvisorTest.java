...
public class TelevisionDisplayAdvisorTest {
  ...
  public void testCheck() {
    String result = TelevisionDisplayAdvisor.check(new Television("RCA", DisplayType.CRT));
    assertEquals("Television with display type CRT should be upgraded", result);
    
    result = TelevisionDisplayAdvisor.check(
      new Television("RCA", DisplayType.LCD),
      new Television("RCA", DisplayType.PLASMA));
