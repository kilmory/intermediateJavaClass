...
public class TelevisionDisplayAdvisorTest {
  ...
  public static void main(String[] args) {
    ...
    TelevisionDisplayAdvisor.check(
      new Television("RCA",   10, OLED),
      new Television("RCA",   10, CRT),     // should generate output message
      new Television("Sony",  50, PLASMA),
      new Television("Zenith", 0, CRT));    // should generate output message
    System.out.println("-----");
    ...
    Television[] tvArray = { new Television("Sony", 50, PLASMA), new Television("RCA", 10, CRT) };
