...
public class TelevisionClient {
  ...
  public static void main(String[] args) {
    ...
    Television tv3 = new Television("Sony", 50, LED);  // LED: static import of DisplayType constants
    System.out.println(tv3);
    System.out.println();
    
    // try out "equal" Television instances - display now included in comparison
    Television tvA = new Television("Sony", 50, PLASMA);
    Television tvB = new Television("Sony", 50, PLASMA);
    Television tvC = new Television("Sony", 50, LCD);
