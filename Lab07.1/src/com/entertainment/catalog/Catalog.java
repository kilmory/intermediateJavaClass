...
public class Catalog {
	...
	/**
	 * Searches catalog by brand. Returns a collection of matching Televisions.
	 * DONE: change Object return type. DONE: implement the method and test it.
	 */
	public static Collection<Television> findByBrand(String brand) {
		// DONE: create a bucket for results - a no-matches result is an empty
		// collection (not null)
	...
	/**
	 * Searches catalog by several brands. Returns a map with an entry for each
	 * brand supplied, along with a collection of matching Televisions for that
	 * brand. DONE: change Object return type. DONE: implement the method and
	 * test it.
	 */
	...
	/**
	 * Returns entire catalog. NOTE: returning direct reference has serious
	 * consequences - a client can manipulate it, since it has a direct
	 * reference to it. Sometimes this is okay, but not here. DONE: change this
	 * to return a read-only view of the catalog - see Collections *class*
	 */
	...
	/*
	 * Loads catalog. Static initializers execute when the class is loaded into
	 * the JVM.
	 */
	static {
